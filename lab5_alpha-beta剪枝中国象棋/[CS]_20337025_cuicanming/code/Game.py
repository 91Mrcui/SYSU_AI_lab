...
class BackChess(pygame.sprite.Sprite):
    def __init__(self, screen):
        self.screen = screen
        self.image = pygame.image.load("F:\chess\\alpha-beta-AIchess\images\\back.png")
...
class Reset(pygame.sprite.Sprite):
    def __init__(self,screen):
        self.screen=screen
        self.image=pygame.image.load("F:\chess\\alpha-beta-AIchess\images\\btn_lose.png")
        self.rect = self.image.get_rect()
...
class Exit(pygame.sprite.Sprite):
    def __init__(self,screen):
        self.screen=screen
        self.image=pygame.image.load("F:\chess\\alpha-beta-AIchess\images\\btn_exit.png")
        self.rect = self.image.get_rect()
...
class Game(object):
    ...
    def __init__(self, screen, chessboard):
        ...
        self.player_tips_r_image = pygame.image.load("F:\chess\\alpha-beta-AIchess\images\\red.png")
        self.player_tips_r_image_topleft = (550, 500)
        self.player_tips_b_image = pygame.image.load("F:\chess\\alpha-beta-AIchess\images\\black.png")
        ...
        self.attack_img = pygame.image.load("F:\chess\\alpha-beta-AIchess\images\\pk.png")
        self.show_win = False
        self.win_img = pygame.image.load("F:\chess\\alpha-beta-AIchess\images\\win.png")

        self.lost_img=pygame.image.load("F:\chess\\alpha-beta-AIchess\images\\lost2.png")
